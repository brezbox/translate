...
#         if file:
#             po = polib.pofile(file.stream.read().decode('utf-8'))
#             # Translate each entry
#             for entry in po.untranslated_entries():
#                 result = translate_client.translate(entry.msgid, target_language='es')
#                 entry.msgstr = result['translatedText']
#             # Instead of saving to a file, write to BytesIO as string
#             buffer = io.BytesIO()
#             buffer.write(str(po).encode('utf-8'))
#             buffer.seek(0)
#             # Serve the buffer content as a file download
#             return send_file(
#                 buffer,
#                 as_attachment=True,
...
#             )
#     # If GET request or no file uploaded, show the upload form
#     return '''
# <!doctype html>
# <html lang="en">
# <head>
